...
The URL of the GitHub repository is https://github.com/omousa98/Text-Editor.git and the repository name is Text-Editor.

🚀The application has been deployed to Heroku and the URL of the deployed application is:-
 
https://whispering-gorge-85485.herokuapp.com/
